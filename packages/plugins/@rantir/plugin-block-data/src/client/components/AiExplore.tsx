...
export const AiExplore: FC<InfoProps> = withDynamicSchemaProps(
  ({ collectionName, data, collectionFields, token, loading }) => {
    if (data) {
      ...
      const [chosenAI, setchosenAI] = useState('LLama AI');
      ...
      const setUpDBforAI = async (collectionName: string) => {
        ...
        if (vectorSetup.count === 0) {
          ...
          if (message === 'success') {
            ...
            const { allQuestions } = await getAIQuestions(collectionFields, 4, info, token);
          ...
          >
            ...
            >
              <FormControl sx={{ m: 1, minWidth: 180 }} size="small">
                ...
                >
                  <MenuItem value="LLama AI">Llama 3.1</MenuItem>
                  <MenuItem value="Mistral">Mistral</MenuItem>
                  <MenuItem value="Gemma">Gemma 2</MenuItem>
